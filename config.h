...
static const char *MARK_FG[]  = { "Nsxiv.mark.foreground",     "#f38ba8" };

#if HAVE_LIBFONTS

static const char *BAR_BG[]   = { "Nsxiv.bar.background",      "#11111b" };
static const char *BAR_FG[]   = { "Nsxiv.bar.foreground",      "#cdd6f4" };
static const char *BAR_FONT[] = { "Nsxiv.bar.font",            "JetBrainsMono-11" };
...
static const keymap_t keys[] = {
	...
	{ 0,            XK_n,             i_navigate,           +1 },
	{ 0,            XK_x,             i_scroll_to_edge,     DIR_LEFT | DIR_UP },
	...
	{ ControlMask,  XK_Right,             i_navigate_frame,     +1 },
	{ ControlMask,  XK_Left,             i_navigate_frame,     -1 },
